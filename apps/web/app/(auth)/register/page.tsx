            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <form onSubmit={handleNextStep} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input type="text" required placeholder="Smith" className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue outline-none transition-all" value={lastName} onChange={(e) => setLastName(e.target.value)} />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-brand-navy mb-2">Email Address</label>
                    <input type="email" required placeholder="you@example.com" className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue outline-none transition-all" value={email} onChange={(e) => setEmail(e.target.value)} />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-brand-navy mb-2">Phone Number</label>
                    <input type="tel" required placeholder="+234 909 176 1957" className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue outline-none transition-all" value={phone} onChange={(e) => setPhone(e.target.value)} />
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-brand-navy mb-2">Password</label>
                    <input type="password" required minLength={8} placeholder="••••••••" className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue outline-none transition-all" value={password} onChange={(e) => setPassword(e.target.value)} />
                  </div>
                  ...
                  <button type="button" onClick={handleGoogleSignUp} className="w-full flex items-center justify-center gap-3 border-2 border-brand-border py-3.5 rounded-xl hover:bg-gray-50 transition-all font-medium text-brand-navy shadow-sm">
              ...
              {step === 2 && (
                <form onSubmit={handleNextStep} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {COURSES.map(course => (
                      <div 
                        ...
                        className={`cursor-pointer border-2 rounded-xl p-5 transition-all ${selectedCourse === course.id ? 'border-brand-blue bg-brand-blue/5' : 'border-brand-border hover:border-gray-300 bg-white'}`}
                      >
                  ...
                  <div className="flex gap-4 pt-6">
                    <button type="button" onClick={handlePrevStep} className="px-6 py-4 rounded-xl font-semibold border-2 border-brand-border hover:bg-gray-50 transition-all">Back</button>
              ...
              {step === 3 && (
                <form onSubmit={handleNextStep} className="space-y-5">
                  {selectedCourse === "ui-ux" && (
                    <>
                      <div>
                        <label className="block text-sm font-semibold text-brand-navy mb-2">Do you have prior experience with Figma or Adobe XD?</label>
                        <select className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none" onChange={(e) => handleDynamicAnswer("figma_exp", e.target.value)} required>
                      ...
                      <div>
                        <label className="block text-sm font-semibold text-brand-navy mb-2">Link to a design portfolio (Optional)</label>
                        <input type="url" placeholder="https://dribbble.com/..." className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none" onChange={(e) => handleDynamicAnswer("portfolio", e.target.value)} />
                      </div>
                    </>
                  )}
                  ...
                  {(selectedCourse === "motion-graphics" || selectedCourse === "video-production") && (
                    <>
                      <div>
                        <label className="block text-sm font-semibold text-brand-navy mb-2">What editing software are you most familiar with?</label>
                        <select className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none" onChange={(e) => handleDynamicAnswer("software", e.target.value)} required>
                          <option value="">Select an option...</option>
                      ...
                      <div>
                        <label className="block text-sm font-semibold text-brand-navy mb-2">Link to a video you've edited (Optional)</label>
                        <input type="url" placeholder="https://youtube.com/..." className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none" onChange={(e) => handleDynamicAnswer("video_link", e.target.value)} />
                      </div>
                    </>
                  )}
                  ...
                  {selectedCourse === "3d-animation" && (
                    <>
                      <div>
                        <label className="block text-sm font-semibold text-brand-navy mb-2">Do you have a PC or Mac with a dedicated GPU?</label>
                        <select className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none" onChange={(e) => handleDynamicAnswer("has_gpu", e.target.value)} required>
                          <option value="">Select an option...</option>
              ...
              {step === 4 && (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    <label className="block text-sm font-semibold text-brand-navy mb-2">Current Occupation / Status</label>
                    <select className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none" value={occupation} onChange={(e) => setOccupation(e.target.value)} required>
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-brand-navy mb-2">Why do you want to join this program?</label>
                    <textarea 
                      required 
                      placeholder="Tell us what you hope to achieve..." 
                      className="w-full px-4 py-3.5 bg-gray-50 border border-brand-border rounded-xl focus:bg-white focus:ring-2 focus:ring-brand-blue/20 outline-none min-h-[120px] resize-none" 
                      value={whyJoin} 
                  ...
                  <div className="flex gap-4 pt-6">
                    <button type="button" disabled={loading} onClick={handlePrevStep} className="px-6 py-4 rounded-xl font-semibold border-2 border-brand-border hover:bg-gray-50 transition-all disabled:opacity-50">Back</button>
